...
import { MotionFileType, MotionSequenceItem } from '../emoteController/type';
...
export class Model {
   ...
   * 按顺序播放一系列动作
   */
  public playMotionSequence(items: MotionSequenceItem[], onComplete?: () => void) {
    this.emoteController?.playMotionSequence(items, onComplete);
  }
